...
const Works = () => {
    ...
    return (
        <div id='works' className="works m-auto max-w-[1920px] w-full h-auto pt-[100px] ">
            ...
            <div className="works-con max-w-[1300px] w-full h-auto m-auto flex flex-col ">
            ...
            <div className="prioritet max-w-[1920px] w-full h-auto pt-[70px] pb-[150px] max-p768:py-10 ">

                <div className="prioritet-con max-w-[1300px] w-full h-auto m-auto flex flex-col px-[100px] max-p1024:px-5 ">
                    ...
                    <div data-aos="zoom in" className='prioritet-con2 max-w-[1260px] w-full h-auto pt-20 flex flex-row justify-between aos-init aos-animate max-p992:gap-3 max-p768:flex-wrap max-p768:pt-4 max-p768:justify-center '>

                        <div className="pr-card1 max-w-[220px] w-full h-auto flex flex-col text-white gap-5 items-center ">
                            <img className='max-w-[135px] w-full max-h-[135px] h-full ' src={clock} />
                            <h2 className='text-[15px] font-bold '>{t('Saving Your Time')}</h2>
                        </div>

                        <div className="pr-card2 max-w-[220px] w-full h-auto flex flex-col text-white gap-5 items-center ">
                        ...
                        <div className="pr-card3 max-w-[220px] w-full h-auto flex flex-col text-white gap-5 items-center ">
                        ...
                        <div className="pr-card4 max-w-[220px] w-full h-auto flex flex-col text-white gap-5 items-center ">
                    ...
                    <div className="pr-numbers max-w-[970px] w-full h-auto relative m-auto mt-[100px] rounded-3xl bg-pink-900 max-p640:max-w-[450px] max-p640:mt-8 ">
                        ...
                        <div className="nums flex flex-row max-w-[970px] w-full h-auto text-white justify-between pb-5 max-p992:max-w-[700px] max-p992:m-auto max-p768:max-w-[550px] max-p640:flex-col max-p640:gap-5">

                            <div data-aos="zoom-in" className="num-card1 flex flex-col items-center aos-init aos-animate">
                                <h1 className='number text-[30px] p768:text-[60px] p992:text-[100px] text-white font-bold'>7320</h1>
                                <h5 className='number-text uppercase text-[14px] p480:text-[16px] text-white font-bold'>{t('Issued Visas')}</h5>
                            </div>

                            <div data-aos="zoom-in" className="num-card2 flex flex-col items-center aos-init aos-animate">
                                <h1 className='number text-[30px] p768:text-[60px] p992:text-[100px] text-white font-bold'>7257</h1>
                                <h5 className='number-text uppercase text-[14px] p480:text-[16px] text-white font-bold'>{t('Successful Trips')}</h5>
                            </div>

                            <div data-aos="zoom-in" className="num-card3 flex flex-col items-center aos-init aos-animate">
                                <h1 className='number text-[30px] p768:text-[60px] p992:text-[100px] text-white font-bold'>7250</h1>
                                <h5 className='number-text uppercase text-[14px] p480:text-[16px] text-white font-bold'>{t('Satisfied Clients')}</h5>
                            </div>
